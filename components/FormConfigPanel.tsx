        ...
        <>
          ...
          {activeSection === "notifications" && (
            <div className="space-y-4">
                ...
                {config.googleSheets.enabled && (
                  <div className="px-3 py-3 space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setConfig((c) => ({
                            ...c,
                            googleSheets: { ...c.googleSheets, spreadsheetId: e.target.value },
                          }))
                        }
                        className="w-full border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs outline-none focus:border-[#00AFCC] font-mono"
                      />
                    </div>
                    <div>
                      <label className="text-[11px] font-semibold text-gray-600 block mb-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setConfig((c) => ({
                            ...c,
                            googleSheets: { ...c.googleSheets, sheetName: e.target.value },
                          }))
                        }
                        className="w-full border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs outline-none focus:border-[#00AFCC]"
                      />
                    ...
                    <p className="text-[10px] text-gray-400">
                      GOOGLE_SERVICE_ACCOUNT_JSON 環境変数の設定が必要です。
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border border-gray-200 rounded-xl overflow-hidden">
                <div className="flex items-center justify-between px-3 py-2.5 bg-gray-50">
                  <p className="text-xs font-bold text-gray-700">🔗 Webhook</p>
                  <button
                    onClick={() =>
                      setConfig((c) => ({
                        ...c,
                ...
                {config.webhook.enabled && (
                  <div className="px-3 py-3 space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setConfig((c) => ({
                            ...c,
                            webhook: { ...c.webhook, url: e.target.value },
                          }))
                        }
                        className="w-full border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs outline-none focus:border-[#00AFCC] font-mono"
                      />
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder="X-Webhook-Secret ヘッダーで送信"
                        value={config.webhook.secretToken}
                        onChange={(e) =>
                          setConfig((c) => ({
                            ...c,
                            webhook: { ...c.webhook, secretToken: e.target.value },
                          }))
                        }
                        className="w-full border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs outline-none focus:border-[#00AFCC] font-mono"
                      />
                    ...
                    <p className="text-[10px] text-gray-400">
                      Zapier / Make / n8n / LINE / Slack などに対応
                    </p>
                  </div>
                )}
              </div>
