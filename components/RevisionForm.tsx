  ...
  return (
    <div className="space-y-3">
      ...
      <textarea
        ...
        rows={4}
        className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#00AFCC] resize-none disabled:opacity-50 disabled:bg-gray-50"
      />
      <button
        type="button"
